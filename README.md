...
I built this with the MERN stack ([Mongodb](https://www.mongodb.com/), [ExpressJS](https://expressjs.com/), [NodeJS](https://nodejs.org/) [ReactJS](https://reactjs.org/)). I used the [Mongoose](https://mongoosejs.com/) ODM for the MongoDB. I also used raw CSS for the design of the GUI.
